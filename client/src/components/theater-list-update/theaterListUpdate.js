            ...
            <table>
                <tbody>
                    {this.props.theaterList.map(theater => {
                        return (
                            <tr key={theater._id}>
                                <td value={theater} onClick={() => this.deleteTheater(theater)} className="theater-td" style={{maxWidth: '15px', color: '#66B9BF'}}><i className="material-icons" style={{cursor: 'pointer', maxWidth: '25px'}}>delete</i></td>
